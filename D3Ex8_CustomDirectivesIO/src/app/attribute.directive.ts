...
export class AttributeDirective implements OnInit {
    ...
    ngOnInit() {
        setTimeout(
            ()=>this.el.nativeElement.innerHTML = `<b style="color:red; cursor:pointer;">ClickMe</b> <br> Parameters : ${this.attributeDirective}, ${this.param?.name}, ${this.param1}, ${this.param2}, ${this.param3}`
            , 2000)
        }
